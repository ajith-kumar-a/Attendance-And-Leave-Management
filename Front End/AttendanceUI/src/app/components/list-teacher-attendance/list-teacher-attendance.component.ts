...
@Component({
  selector: 'app-list-teacher-attendance',
  templateUrl: './list-teacher-attendance.component.html',
  styleUrl: './list-teacher-attendance.component.css'
})
export class ListTeacherAttendanceComponent {
  roleId: number = 2; // Fixed role ID to 1 for students
