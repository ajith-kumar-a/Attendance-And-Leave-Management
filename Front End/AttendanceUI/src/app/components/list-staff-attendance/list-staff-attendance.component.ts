...
@Component({
  selector: 'app-list-staff-attendance',
  templateUrl: './list-staff-attendance.component.html',
  styleUrl: './list-staff-attendance.component.css'
})
export class ListStaffAttendanceComponent {
  roleId: number = 3; // Fixed role ID to 1 for students
