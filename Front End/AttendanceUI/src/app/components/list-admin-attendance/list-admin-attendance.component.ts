...
@Component({
  selector: 'app-list-admin-attendance',
  templateUrl: './list-admin-attendance.component.html',
  styleUrl: './list-admin-attendance.component.css'
})
export class ListAdminAttendanceComponent {
  roleId: number = 4; // Fixed role ID to 1 for students
